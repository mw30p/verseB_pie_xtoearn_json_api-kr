...
- JSON API SAMPLE : [JSON](https://github.com/mw30p/verseB_pie_xtoearn_json_api-kr/tree/main/src).
- JAVA API SAMPLE : [JAVA](https://github.com/mw30p/verseB_pie_xtoearn_java_api-kr/tree/main/src/main/java/com/mw30p/p2e).
